...
# Misal pakai YOLOv8n yang umum, tapi bisa diganti model custom wajah
print("[INFO] Loading YOLO model...")
# yolo_model = YOLO("yolov8n.pt")  # atau ganti dengan model wajah custom
yolo_model = YOLO("yolov8n-face.pt")  # atau ganti dengan model wajah custom
